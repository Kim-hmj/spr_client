...
//for adk sys
#define LOG(...) AIXLOG_INTERNAL__LOG_MACRO_CHOOSER(__VA_ARGS__)(__VA_ARGS__) << " - ["  << FUNC << "]" << " "
# endif
...
#define off_state 0
#define pos_state 2
extern int change_connection;
extern int frist_time_connect;
extern int send_flag;
extern int say_hello;
extern int say_bye;
extern int client_num;
extern int compare_ip;
